...
extern int message_id = 0;

int init()
{
	nquotes_setup("MetaQuotesSample.ForexFactory", "ForexFactory");
	nquotes_set_property_double("lots", lots);
	nquotes_set_property_int("message_id", message_id);
	return (nquotes_init());
}
